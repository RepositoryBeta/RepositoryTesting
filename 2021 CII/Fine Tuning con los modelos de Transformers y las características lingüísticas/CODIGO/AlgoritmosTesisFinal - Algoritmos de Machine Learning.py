...
fields = ('N° Características',  'Nodos', 'Máximo de Iteraciones')
...
class Regresiones():
    ...
    def Algoritmos(self):
        ...
        if self.seleccion == 'Sg':
            ...
            regressor = make_pipeline(StandardScaler(),SGDRegressor(max_iter=self.maxiteracc, random_state=0))
        ...
        if self.seleccion == 'Gr':
            ...
            regressor = GradientBoostingRegressor(n_estimators=self.nodos,random_state=0)
        ...
        if self.seleccion == 'vo':
            print('ejecuto vo')
            regressorgra = GradientBoostingRegressor(n_estimators=self.nodos,random_state=0)
            regressorada = AdaBoostRegressor(DecisionTreeRegressor(), n_estimators=self.nodos, random_state=0)
            regressorran = RandomForestRegressor(n_estimators=self.nodos, random_state=0)
            regressorgra.fit(self.x_train, self.y_train)
            regressorada.fit(self.x_train, self.y_train)
            regressorran.fit(self.x_train, self.y_train)
            pred1 = regressorgra.predict(self.x_train)
            pred2 = regressorada.predict(self.x_train)
            pred3 = regressorran.predict(self.x_train)
            regressor = VotingRegressor(estimators=[('Gr', regressorgra), ('Ada', regressorada), ('Rf', regressorran)])
        ...
        # Validacion Cruzada
        print("RESULTADO ALGORITMO APLICANDO VALIDACION CRUZADA")
        scores = cross_validate(regressor, self.x_train, self.y_train,
                                scoring=['neg_mean_absolute_error', 'neg_mean_squared_error',
                                         'neg_root_mean_squared_error'], cv=3)

        n1 = scores['test_neg_mean_absolute_error'].mean()
        n2 = int(-1)
        mul1 = n1 * n2

        m1 = scores['test_neg_mean_squared_error'].mean()
        m2 = int(-1)
        mul2 = m1 * m2

        l1 = scores['test_neg_root_mean_squared_error'].mean()
        l2 = int(-1)
        mul3 = l1 * l2
        print('M.A.E.','\t', mul1)
        print('M.S.E.','\t', mul2)
        ...
        self.r2 = metrics.r2_score(self.y_test, self.y_pred)
        # Aplicando R2
        print('R2 : %.2f' % self.r2)
        # Aplicando Pearson
        pearson_r = np.corrcoef(self.y_test, self.y_pred)
        print(pearson_r[0, 1])
        ...
        if self.seleccion == 'vo':
            ...
            plt.figure()
            plt.plot(pred1, 'gd', label='GradientBoost')
            plt.plot(pred2, 'b^', label='AdaBoost')
    ...
    def graficos(self):
        ...
        axes.plot([self.y_test.min(), self.y_test.max()], [self.y_test.min(), self.y_test.max()],
                  color='black', lw=1)
        axes.set_title('Prediction vs Complexity', fontsize=10, fontweight="bold")
    ...
    def generaexcel(self):
        ...
        self.datas.insert(loc=27,
                          column='Prediccion',
                          value=self.y_pred)
        # Crear archivo
        if self.seleccion == 'Ada':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_AdaBoostRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Dt':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_DecisionTreeRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Rf':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_RandomForestRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Lr':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_LinearRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Pa':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_PassiveAggressiveRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Sg':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_SGDRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Svr':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_SVR.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Gr':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_GradientBoostingRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Kn':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_KNeighborsRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'vo':
           writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_VotingRegressor.xlsx',
                                  engine='xlsxwriter')
        ...
        print("RESULTADO DATOS INGRESADOS POR EL USUARIO")
        print(df)
        ...
        # Crear archivo
        if self.seleccion == 'Ada':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_AdaBoostRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Dt':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_DecisionTreeRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Rf':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_RandomForestRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Lr':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_LinearRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Pa':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_PassiveAggressiveRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Sg':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_SGDRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Svr':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_SVR_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Gr':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_GradientBoostingRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Kn':
            writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_KNeighborsRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'vo':
           writer = pd.ExcelWriter('C:/Users/Jostin/Downloads/Tesis Escobar y Sorroza 2021 CII/Pruebas algoritmo Kevin/result_test_VotingRegressor_errores.xlsx',
                                  engine='xlsxwriter')
        # Convert de dataframe and insert in document
    ...
    def validaentradas(self, entradas):
        try:
            ...
            showinfo(
                title='Error',
                message="Por favor no deben haber: vacios o no numéricos")
