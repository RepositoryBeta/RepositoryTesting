...
datosM2 = pd.read_excel('resultados/Palabras Separadas Texto.xlsx',engine="openpyxl",sheet_name= 4)
...
writer = ExcelWriter('resultados/MatrizConfusionMF.xlsx')
df.to_excel(writer, 'Frases', index=False)
