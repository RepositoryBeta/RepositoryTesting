...
class Regresiones():
    ...
    def CargarArchivo(self):
        ...
        #self.filename = filedialog.askopenfilename(filetypes=(("Archivo xlsx", "*.xlsx"),))
        df = pd.read_csv(self.filename)
        #data = df['abs_frecuency']
        #bins = np.arange(min(data), max(data) + 3, 1)
        #plt.hist(df['abs_frecuency'], bins)
        """"
        data = pd.Series(['abs_frecuency', 'rel_frecuency','length','number_syllables','token_possition','number_token_sentences',
                          'number_synonyms','number_hyponyms','number_hypernyms','Part_of_speech','freq_relative_word_before',
                          'freq_relative_word_after','len_word_before','len_word_after','mtld_diversity','propn','aux'])
        #data.hist()
        #plt.hist(data, bins=60)
        
        plt.title('Python Histogram Example')
        plt.ylabel('rango')
        plt.xlabel('cantidad registro')
        plt.show()
        """
        print(self.filename)
        self.LeerArchivo()
    ...
    def columnasArchivo(self):
        ...
        if self.filenamet:
            ...
            #Presentar el histograma
            #self.filename = df['abs_frecuency']
    ...
    def Algoritmos(self):
        ...
        if self.seleccion == 'Gr':
            ...
            #regressor = make_pipeline(StandardScaler(),
             #                         GradientBoostingRegressor(n_estimators=self.nodos, random_state=0))
        ...
        #Aplicando R2
        print('R2 : %.2f' % self.r2)
        #self.pear = scipy.stats.pearsonr(self.y_test, self.y_pred)
        #self.pear1, self.pear2 = scipy.stats.pearsonr(self.y_test, self.y_pred)
        #print('PEARSON 1 : %.2f - %.2f', self.pear1)
        #print('PEARSON 2 : %.2f - %.2f', self.pear2)
        #self.coe = np.corrcoef(self.y_test, self.y_pred)
    ...
    def graficos(self):
        ...
        #my_data = pd.Series(self.x_train[:5])
        #my_data.hist()
    ...
    def generaexcel(self):
        ...
        # Crear archivo
        if self.seleccion == 'Ada':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_AdaBoostRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Dt':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_DecisionTreeRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Rf':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_RandomForestRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Lr':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_LinearRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Pa':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_PassiveAggressiveRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Sg':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_SGDRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Svr':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_SVR.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Gr':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_GradientBoostingRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Kn':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_KNeighborsRegressor.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'vo':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_VotingRegressor.xlsx',
                                    engine='xlsxwriter')
        ...
        """"df = pd.DataFrame({'ValueK': valores_,
                           ...
                           'R.M.S.E.': self.mul3,
                           'R2': self.r2,
                           'PEARSON ': pearson_r[0,1]})
        print("RESULTADO DATOS validacion Cruzada - CROSS VALIDATION")
        print(df)"""""


        # Crear archivo
        if self.seleccion == 'Ada':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_AdaBoostRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Dt':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_DecisionTreeRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Rf':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_RandomForestRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Lr':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_LinearRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Pa':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_PassiveAggressiveRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Sg':
            writer = pd.ExcelWriter('C:/Users/josep/Desktop/pru/result_test_SGDRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Svr':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_SVR_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Gr':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_GradientBoostingRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'Kn':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_KNeighborsRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        if self.seleccion == 'vo':
            writer = pd.ExcelWriter('C:/Users/joe-s/Desktop/pru/result_test_VotingRegressor_errores.xlsx',
                                    engine='xlsxwriter')
        # Convert de dataframe and insert in document
