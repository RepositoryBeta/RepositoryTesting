...
class TextComplexityStanford():
    ...
    # Number of distinct content words ****palabras diferentes del texto
        self.N_dcw = 0
        try:
            # VOCABULARIO
    ...
    def sentenceComplexity(self):
        ...
        for sentence in self.new_pos_sentences:
            ...
            count = 0
            # print("\nExpresion regular:  ",sentence)
            for w in sentence:
                if re.match('V.*', w[1]):
                    # print("\n",re.match('V.*', w[1]),"  prev:",previous_is_verb)
                    if (previous_is_verb):
                        count += 1
                        previous_is_verb = False
                    else:
    ...
    def punctuationMarks(self):
        ...
        # print("\nSignos: ",new_text ,"\ncontent sentences: ",self.pos_content_sentences)
