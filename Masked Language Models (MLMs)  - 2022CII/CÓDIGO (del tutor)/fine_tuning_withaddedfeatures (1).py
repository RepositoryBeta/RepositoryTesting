...
DATA_FILE_PATH = "/content/drive/MyDrive/Tesis/corpus/Complex.xlsx"
...
MODEL_PATH = "/content/roberta-base"  

    #SE USA MODELO ROBERTA-LARGE PARA IDIOMA INGLÉS    
#MODEL_PATH = "/content/roberta-large"  

    #SE USA MODELO XLM-ROBERTA-LARGE PARA IDIOMA INGLÉS
#MODEL_PATH = "/content/drive/MyDrive/Tesis/Xlm-roberta-large/xlm-roberta-large"  
...
EPOCHS = 10		#20 cuando las incrustaciones son de 1024 (input_dim = 1024)

    #SE ESCRIBE EL DIRECTORIO DONDE SE GUARDARÁ EL NUEVO MODELO EJECUTADO
OUTPUT_PATH = "/content/drive/MyDrive/Tesis/" + MODEL_PATH.split('/')[-1] + "-finetuned"
