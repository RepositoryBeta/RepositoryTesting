...
class CorporaFrequencyRNN(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        #Bert Spanish
        self.tokenizer = RobertaTokenizer.from_pretrained('PlanTL-GOB-ES/roberta-large-bne')
        self.model = RobertaModel.from_pretrained('PlanTL-GOB-ES/roberta-large-bne')
        ...
        self.model_en = RobertaModel.from_pretrained('PlanTL-GOB-ES/roberta-large-bne')
        self.lenSentence = []
